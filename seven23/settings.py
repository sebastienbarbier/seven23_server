...
MAINTENANCE = os.environ.get('MAINTENANCE').lower() == 'true'

# Allow public account creation
ALLOW_ACCOUNT_CREATION = os.environ.get('ALLOW_ACCOUNT_CREATION').lower() == 'true'
OLD_PASSWORD_FIELD_ENABLED = True

APPEND_SLASH = True
ALLOWED_HOSTS = ['*']

SAAS = os.environ.get('SAAS').lower() == 'true'
TRIAL_PERIOD = 30
...
if os.environ.get('STORAGE').lower() == 's3':
    # aws settings
...
if os.environ.get('EMAIL_BACKEND_CONSOLE').lower() == 'true' or not EMAIL_HOST:
